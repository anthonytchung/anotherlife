...
export default function UploadWindow() {
  ...
  return (
    <Draggable bounds="parent" nodeRef={draggableRef} offsetParent={document.body} className="cursor-move">
      <div className="window active" style={{ maxWidth: 400 }}>
        <div className="title-bar" ref={draggableRef}>
          <div className="title-bar-text">IMGtoFilm</div>
        ...
        <div className="window-body has-space">
          ...
          {/* Tab Panels */}
          <article role="tabpanel" id="music" hidden={activeTab !== "music"}>
          ...
          <article role="tabpanel" id="dogs" hidden={activeTab !== "dogs"}>
            <Image
              className="w-full"
